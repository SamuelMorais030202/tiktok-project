...
export default function PrivacyPolicy() {
  return (
    ...
    <div className="texts">
      ...
      <br />
      <br />
      Mais informaçõesEsperemos que esteja esclarecido e, como mencionado anteriormente, se houver algo que você não tem certeza se precisa ou não, geralmente é mais seguro deixar os cookies ativados, caso interaja com um dos recursos que você usa em nosso site.Esta política é efetiva a partir de 20 March 2023 23:56</p>
    </div>
    </main>
  )
}